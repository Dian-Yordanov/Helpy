...
#Include %A_ScriptDir%\Directory_for_Scroll_version_2\class_scrollgui.ahk
...
Gui, Example_with_tabs_:New, +HwndGuiHwnd
...
; Gui, Example_with_tabs_:New, +hwndHGUI
...
Gui, Margin, 20, 20
I := 0
Gui,  Example_with_tabs_:Add, Text, w370 h20 0x200 Section, % "Edit " . ++I
Gui,  Example_with_tabs_:Add, Edit, xp y+0 wp r6
Loop, 12 {
   Gui,  Example_with_tabs_:Add, Text, xp y+0 wp h20 0x200, % "Edit " . ++I
   Gui,  Example_with_tabs_:Add, Edit, xp y+0 wp r6
}
Gui,  Example_with_tabs_:Add, Text, ys wp h20 0x200, % "Edit " . ++I
Gui,  Example_with_tabs_:Add, Edit, xp y+0 wp r6
Loop, 12 {
   Gui,  Example_with_tabs_:Add, Text, xp y+0 wp h20 0x200, % "Edit " . ++I
   Gui,  Example_with_tabs_:Add, Edit, xp y+0 wp r6
...
SG1 := New ScrollGUI(GuiHwnd, 800, 800, "+Resize -Caption -Border +LabelGui1 -DPIScale", 3, 3)
; SG1 := New ScrollGUI(HGUI, 400, 400, "+Resize +MinSize +LabelGui1", 3, 3)
; Show ScrollGUI1
SG1.Show("ScrollGUI1 Title", "x50 y50")
