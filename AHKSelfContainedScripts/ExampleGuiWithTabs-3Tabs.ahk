...
Gui, Example_with_tabs_:Add, Picture, vMenuHover HwndhMenuHover Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-menu-hover.png
Gui, Example_with_tabs_:Add, Picture, vMenuPressed HwndhMenuPressed Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-menu-pressed.png
Gui, Example_with_tabs_:Add, Picture, vMenuSelect HwndhMenuSelect, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-menusel.png
Gui, Example_with_tabs_:Add, Picture, vMenuSelectPurple HwndhMenuSelectPurple, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-menusel-purple.png
Gui, Example_with_tabs_:Add, Picture, vMenuAlternativeColour HwndhMenuAlternativeColour, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-menu-hover-alternative-colour.png

Gui, Example_with_tabs_:Add, Picture, vBorderTop, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\border-top-normal.png
Gui, Example_with_tabs_:Add, Picture, vBorderBottom, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\border-top-normal.png
Gui, Example_with_tabs_:Add, Picture, vBorderLeft, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\border-top-normal.png
Gui, Example_with_tabs_:Add, Picture, vBorderRight, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\border-top-normal.png
Gui, Example_with_tabs_:Add, Picture, vBtnBackN HwndhBtnBackN Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-back-normal.png
Gui, Example_with_tabs_:Add, Picture, vBtnBackH HwndhBtnBackH Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-back-hover.png
Gui, Example_with_tabs_:Add, Picture, vBtnBackP HwndhBtnBackP Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-back-pressed.png
Gui, Example_with_tabs_:Add, Picture, vBtnCloseN HwndhBtnCloseN, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-close-normal.png
Gui, Example_with_tabs_:Add, Picture, vBtnCloseH HwndhBtnCloseH Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-close-hover.png
Gui, Example_with_tabs_:Add, Picture, vBtnCloseP HwndhBtnCloseP Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-close-pressed.png
Gui, Example_with_tabs_:Add, Picture, vBtnMaxN HwndhBtnMaxN, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-maximize-normal.png
Gui, Example_with_tabs_:Add, Picture, vBtnMaxH HwndhBtnMaxH Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-maximize-hover.png
Gui, Example_with_tabs_:Add, Picture, vBtnMaxP HwndhBtnMaxP Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-maximize-pressed.png
Gui, Example_with_tabs_:Add, Picture, vBtnRestoreN HwndhBtnRestoreN Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-restore-normal.png
Gui, Example_with_tabs_:Add, Picture, vBtnRestoreH HwndhBtnRestoreH Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-restore-hover.png
Gui, Example_with_tabs_:Add, Picture, vBtnRestoreP HwndhBtnRestoreP Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-restore-pressed.png
Gui, Example_with_tabs_:Add, Picture, vBtnMinN HwndhBtnMinN, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-minimize-normal.png
Gui, Example_with_tabs_:Add, Picture, vBtnMinH HwndhBtnMinH Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-minimize-hover.png
Gui, Example_with_tabs_:Add, Picture, vBtnMinP HwndhBtnMinP Hidden1, %A_ScriptDir%\Directory_For_ExampleGuiWithTabs-3Tabs\images\button-minimize-pressed.png
