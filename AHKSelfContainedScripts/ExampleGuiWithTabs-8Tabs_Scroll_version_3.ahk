...
; Example_with_tabs_CtlShowHide("Hide", "MenuHover")
    ...
    ; Example_with_tabs_CtlShowHide("Hide", "MenuPressed"), Hover := 0
            ...
            ; OnMessage(0x0200, "Example_with_tabs_WM_MOUSEMOVE")

            ; GuiControl, Example_with_tabs_:Hide, MenuHover
            ; Example_with_tabs_CtlShowHide("Hide", "MenuHover")
            ; Example_with_tabs_CtlShowHide("Hide", "MenuPressed")
...
; Example_with_tabs_CtlShowHide("Hide", "MenuHover")
            ...
            if(var_to_check_if_WhiteLineNumberMain3_exists == 0){
                ...
                ; gosub, Example_with_tabs_GuiSize
