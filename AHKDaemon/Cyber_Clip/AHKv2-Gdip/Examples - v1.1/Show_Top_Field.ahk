...
IniRead, minimal_distance_to_the_top_old_var, %new_string%/Cyber_Clip_config_ini_file.ini, LocationConfig, top__distance_location
...
Gui, _distance_to_the_top_old_var: -Caption +E0x80000 +LastFound +AlwaysOnTop +ToolWindow +OwnDialogs
; Gui, 1:Add, Button, x50 y50 cFFFFFF h420 w400 , test
Gui, _distance_to_the_top_old_var: Show, NA

; Get a handle to this window we have created in order to update it later
hwnd_distance_to_the_top_old_var := WinExist()
...
Gdip_FillRectangle(G, pBrush, 0,0, Width, minimal_distance_to_the_top_old_var)
...
UpdateLayeredWindow(hwnd_distance_to_the_top_old_var, hdc, 0, 0, Width, Height)
