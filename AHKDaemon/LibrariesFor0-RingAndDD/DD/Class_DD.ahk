...
class DD_Helper
{
	...
	LoadDll() {
		...
		if(booleanCheckIfDllIsAtThatPlace2 = "true")
		{
			...
			dllLocation64 := A_ScriptDir "\AHKDaemon\LibrariesFor0-RingAndDD\DD\DD64.dll"
			dllLocation32 := A_ScriptDir "\AHKDaemon\LibrariesFor0-RingAndDD\DD\DD32.dll"

			; Msgbox, %dllLocation64%
