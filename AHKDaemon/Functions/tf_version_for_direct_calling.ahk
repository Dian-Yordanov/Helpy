...
TF_...(Text, other parameters)
	{
	 ...
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 ; OW = 0 Copy inputfile
	 ...
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; A_ThisFunc useful for debugging your scripts
	 ...
	 Return TF_ReturnOutPut_version_for_direct_calling(OW, OutPut, FileName, TrimTrailing, CreateNewFile_version_for_direct_calling)
	 ; OW 0 or 1 = file
	 ...
	 ; CreateNewFile_version_for_direct_calling: To create a file that doesn't exist this parameter is needed, only used in few functions
	}

*/

TF_Count_version_for_direct_callingLines_version_for_direct_calling(Text)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
...
TF_ReadLines_version_for_direct_calling(Text, StartLine = 1, EndLine = 0, Trailing = 0)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 Loop, Parse, Text, `n, `r
		{
		 If A_Index in %TF_MatchList%
	 ...
	 Return TF_ReturnOutPut_version_for_direct_calling(OW, OutPut, FileName, Trailing)
	}

TF_Replace_version_for_direct_callingInLines(Text, StartLine = 1, EndLine = 0, SearchText = "", ReplaceText = "")
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 ...
	 Return TF_ReturnOutPut_version_for_direct_calling(OW, OutPut, FileName)
	}

TF_Replace_version_for_direct_calling(Text, SearchText, ReplaceText="")
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 IfNotInString, Text, %SearchText%
		Return Text ; SearchText not in TextFile so return and do nothing, we have to return Text in case of a variable otherwise it would empty the variable contents bug fix 3.3
	 ...
	 Return TF_ReturnOutPut_version_for_direct_calling(OW, Text, FileName, 0)
	}

TF_RegExReplaceInLines_version_for_direct_calling(Text, StartLine = 1, EndLine = 0, NeedleRegEx = "", Replacement = "")
	{
...
TF_RegExReplace_version_for_direct_calling(Text, NeedleRegEx = "", Replacement = "")
	{
	 options:="^[imsxADJUXPS]+\)" ; Hat tip to sinkfaze http://www.autohotkey.com/forum/viewtopic.php?t=60062
	 if RegExMatch(searchText,options,o)
		searchText := RegExReplace(searchText,options,(!InStr(o,"m") ? "m$0" : "$0"))
...
TF_RemoveLines_version_for_direct_calling(Text, StartLine = 1, EndLine = 0)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 Loop, Parse, Text, `n, `r
...
TF_RemoveBlankLines_version_for_direct_calling(Text, StartLine = 1, EndLine = 0)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
...
TF_RemoveDuplicateLines_version_for_direct_calling(Text, StartLine = 1, Endline = 0, Consecutive = 0, CaseSensitive = false)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 If (StartLine = "")
	 	StartLine = 1
	 If (Endline = 0 OR Endline = "")
		EndLine := TF_Count_version_for_direct_calling(Text, "`n") + 1
	 Loop, Parse, Text, `n, `r
		{
...
TF_InsertLine_version_for_direct_calling(Text, StartLine = 1, Endline = 0, InsertText = "")
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 Loop, Parse, Text, `n, `r
...
TF_Replace_version_for_direct_callingLine(Text, StartLine = 1, Endline = 0, ReplaceText = "")
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 Loop, Parse, Text, `n, `r
...
TF_InsertPrefix_version_for_direct_calling(Text, StartLine = 1, EndLine = 0, InsertText = "")
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 Loop, Parse, Text, `n, `r
...
TF_InsertSuffix_version_for_direct_calling(Text, StartLine = 1, EndLine = 0 , InsertText = "")
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 Loop, Parse, Text, `n, `r
...
TF_TrimLeft_version_for_direct_calling(Text, StartLine = 1, EndLine = 0, Count = 1)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 Loop, Parse, Text, `n, `r
...
TF_TrimRight_for_direct_calling(Text, StartLine = 1, EndLine = 0, Count = 1)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 Loop, Parse, Text, `n, `r
...
TF_AlignLeft_for_direct_calling(Text, StartLine = 1, EndLine = 0, Columns = 80, Padding = 0)
	{
		 ...
		 If A_Index in %TF_MatchList%
			{
			 ...
			 If (SpaceNum > 0) and (Padding = 1) ; requires padding + keep padding
				{
				 Left:=TF_SetWidth_version_for_direct_calling(LoopField,Columns, 0) ; align left
				 OutPut .= Left "`n"
				}
			 Else
				OutPut .= LoopField "`n"
...
TF_AlignCenter_for_direct_calling(Text, StartLine = 1, EndLine = 0, Columns = 80, Padding = 0)
	{
	 Trim:=A_AutoTrim ; store trim settings
	 AutoTrim, On ; make sure AutoTrim is on
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
		 ...
		 If A_Index in %TF_MatchList%
			{
			 ...
			 Centered:=TF_SetWidth_version_for_direct_calling(LoopField,Columns, 1) ; align center using set width
			 OutPut .= Centered "`n"
			}
		 Else
			OutPut .= A_LoopField "`n"
...
TF_AlignRight_for_direct_calling(Text, StartLine = 1, EndLine = 0, Columns = 80, Skip = 0)
	{
	 Trim:=A_AutoTrim ; store trim settings
	 AutoTrim, On ; make sure AutoTrim is on
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
		 ...
		 If A_Index in %TF_MatchList%
			{
			 ...
			 Right:=TF_SetWidth_version_for_direct_calling(LoopField,Columns, 2) ; align right using set width
			 OutPut .= Right "`n"
			}
		 Else
			OutPut .= A_LoopField "`n"
...
TF_ConCat_version_for_direct_calling(FirstTextFile, SecondTextFile, OutputFile = "", Blanks = 0, FirstPadMargin = 0, SecondPadMargin = 0)
	{
	 If (Blanks > 0)
		Loop, %Blanks%
	 ...
	 If (OutPutFile = "") ; if OutPutFile is empty return as variable
		OW=2
	 Return TF_ReturnOutPut_version_for_direct_calling(OW, OutPut, OutputFile, 1, 1)
	}

TF_LineNumber_version_for_direct_calling(Text, Leading = 0, Restart = 0, Char = 0) ; HT ribbet.1
	{
	 global t
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 Lines:=TF_Count_version_for_direct_calling(Text, "`n") + 1
...
TF_ColGet_version_for_direct_calling(Text, StartLine = 1, EndLine = 0, StartColumn = 1, EndColumn = 1, Skip = 0)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 If (StartColumn < 0)
	 ...
	 if RegExMatch(StartColumn, ",|\+|-")
		{
		 StartColumn:=_MakeMatchList_version_for_direct_calling(Text, StartColumn, 1, 1)
		 Loop, Parse, Text, `n, `r ; parsing file/var
			{
			 If A_Index in %TF_MatchList%
				{
...
; modified in TF 3.4
TF_ColPut_version_for_direct_calling(Text, Startline = 1, EndLine = 0, StartColumn = 1, InsertText = "", Skip = 0)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 If RegExMatch(StartColumn, ",|\+")
		{
		 StartColumn:=_MakeMatchList_version_for_direct_calling(Text, StartColumn, 0, 1)
		 Loop, Parse, Text, `n, `r ; parsing file/var
			{
			 If A_Index in %TF_MatchList%
				{
...
; modified TF 3.4
TF_ColCut_version_for_direct_calling(Text, StartLine = 1, EndLine = 0, StartColumn = 1, EndColumn = 1)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 If RegExMatch(StartColumn, ",|\+|-")
		{
		 StartColumn:=_MakeMatchList_version_for_direct_calling(Text, StartColumn, EndColumn, 1)
		 Loop, Parse, Text, `n, `r ; parsing file/var
			{
			 If A_Index in %TF_MatchList%
				{
...
TF_ReverseLines_version_for_direct_calling(Text, StartLine = 1, EndLine = 0)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
...
;TF_SplitFileByLines_version_for_direct_calling
;example:
;TF_SplitFileByLines_version_for_direct_calling("TestFile.txt", "4", "sfile_", "txt", "1") ; split file every 3 lines
...
TF_SplitFileByLines_version_for_direct_calling(Text, SplitAt, Prefix = "file", Extension = "txt", InFile = 1)
	{
	 LineCounter=1
	 FileCounter=1
	 Where:=SplitAt
			 ...
			 If (InFile = 0)
				{
				 ...
				 If (CheckOutput <> "") and (OW <> 2) ; skip empty files
					TF_ReturnOutPut_version_for_direct_calling(1, PreviousOutput, Prefix FileCounter "." Extension, 0, 1)
				 If (CheckOutput <> "") and (OW = 2) ; skip empty files
					 TF_SetGlobal_version_for_direct_calling(Prefix FileCounter,PreviousOutput)
				 Output:=
				}
			 If (InFile = 1)
				{
				 ...
				 StringReplace, CheckOutput, CheckOutput, `r, , All
				 If (CheckOutput <> "") and (OW <> 2) ; skip empty files
				 	 TF_ReturnOutPut_version_for_direct_calling(1, Output, Prefix FileCounter "." Extension, 0, 1)
				 If (CheckOutput <> "") and (OW = 2) ; skip empty files
				 	 TF_SetGlobal_version_for_direct_calling(Prefix FileCounter,Output)
				 Output:=
				}
			 If (InFile = 2)
				{
	 ...
	 If (CheckOutput <> "") and (OW = 2) ; output to array
		{
		 TF_SetGlobal_version_for_direct_calling(Prefix FileCounter,Output)
		 TF_SetGlobal_version_for_direct_calling(Prefix . "0" , FileCounter)
		}
	}

; TF_SplitFileByText_version_for_direct_calling("TestFile.txt", "button", "sfile_", "txt") ; split file at every line with button in it, can be regexp
; InFile = 0 skip line e.g. do not include the actual line in any of the output files
; InFile = 1 include line IN current file
; InFile = 2 include line IN next file
TF_SplitFileByText_version_for_direct_calling(Text, SplitAt, Prefix = "file", Extension = "txt", InFile = 1)
	{
	 LineCounter=1
	 FileCounter=1
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
...
TF_Find_version_for_direct_calling(Text, StartLine = 1, EndLine = 0, SearchText = "", ReturnFirst = 1, ReturnText = 0)
	{
	 options:="^[imsxADJUXPS]+\)"
	 if RegExMatch(searchText,options,o)
...
TF_Prepend_version_for_direct_calling(File1, File2)
	{
FileList=
(
%File1%
...
TF_Merge_version_for_direct_calling(FileList,"`n", "!" . File2)
Return
	}

TF_Append_for_direct_calling(File1, File2)
	{
FileList=
(
%File2%
...
; For TF_Merge_version_for_direct_calling You will need to create a Filelist variable, one file per line,
...
TF_Merge_version_for_direct_calling(FileList, Separator = "`n", FileName = "merged.txt")
	{
	 OW=0
	 ...
	 Return TF_ReturnOutPut_version_for_direct_calling(OW, OutPut, FileName, 0, 1)
	}

TF_Wrap_version_for_direct_calling(Text, Columns = 80, AllowBreak = 0, StartLine = 1, EndLine = 0)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 If (AllowBreak = 1)
...
TF_WhiteSpace_version_for_direct_calling(Text, RemoveLeading = 1, RemoveTrailing = 1, StartLine = 1, EndLine = 0) {
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc) ; create MatchList
	 Trim:=A_AutoTrim ; store trim settings
	 AutoTrim, On ; make sure AutoTrim is on
...
TF_Substract_version_for_direct_calling(File1, File2, PartialMatch = 0) {
	Text:=File1
	TF_GetData_version_for_direct_calling(OW, Text, FileName)
	Str1:=Text
	Text:=File2
	...
	Return TF_ReturnOutPut_version_for_direct_calling(OW, OutPut, FileName, 0)
}

; Similar to "BK Replace EM" RangeReplace
TF_RangeReplace_version_for_direct_calling(Text, SearchTextBegin, SearchTextEnd, ReplaceText = "", CaseSensitive = "False", KeepBegin = 0, KeepEnd = 0)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 IfNotInString, Text, %SearchText%
...
TF_MakeFile_version_for_direct_calling(Text, Lines = 1, Columns = 1, Fill = " ")
	{
	 OW=1
	 ...
	 Loop, % Lines
		Output .= Cols "`n"
	 Return TF_ReturnOutPut_version_for_direct_calling(OW, OutPut, Text, 1, 1)
	}

; Convert tabs to spaces, shorthand for TF_Replace_version_for_direct_callingInLines_version_for_direct_calling
TF_Tab2Spaces_version_for_direct_calling(Text, TabStop = 4, StartLine = 1, EndLine =0)
	{
	 Loop, % TabStop
		Replace .= A_Space
	 Return TF_Replace_version_for_direct_callingInLines(Text, StartLine, EndLine, A_Tab, Replace)
	}

; Convert spaces to tabs, shorthand for TF_Replace_version_for_direct_callingInLines_version_for_direct_calling
TF_Space_version_for_direct_callings(Text, TabStop = 4, StartLine = 1, EndLine =0)
	{
	 Loop, % TabStop
		Replace .= A_Space
	 Return TF_Replace_version_for_direct_callingInLines(Text, StartLine, EndLine, Replace, A_Tab)
	}

; Sort (section of) a text file
TF_Sort_version_for_direct_calling(Text, SortOptions = "", StartLine = 1, EndLine = 0) ; use the SORT options http://www.autohotkey.com/docs/commands/Sort.htm
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 ...
	 Else
		{
		 Output := TF_ReadLines_version_for_direct_calling(Text, 1, StartLine-1) ; get first section
		 ToSort := TF_ReadLines_version_for_direct_calling(Text, StartLine, EndLine) ; get section to sort
		 Sort, ToSort, %SortOptions%
		 OutPut .= ToSort
		 OutPut .= TF_ReadLines_version_for_direct_calling(Text, EndLine+1) ; append last section
		}
	 Return TF_ReturnOutPut_version_for_direct_calling(OW, OutPut, FileName)
	}

TF_Tail_version_for_direct_calling(Text, Lines = 1, RemoveTrailing = 0, ReturnEmpty = 1)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 Neg = 0
	 If (Lines < 0)
	 ...
	 OW = 2 ; make sure we return variable not process file
	 Return TF_ReturnOutPut_version_for_direct_calling(OW, OutPut, FileName, RemoveTrailing)
	}

TF_Count_version_for_direct_calling(String, Char)
	{
	StringReplace, String, String, %Char%,, UseErrorLevel
	Return ErrorLevel
	}

TF_Save_version_for_direct_calling(Text, FileName, OverWrite = 1) { ; HugoV write file
	Return TF_ReturnOutPut_version_for_direct_calling(OverWrite, Text, FileName, 0, 1)
	}

TF_version_for_direct_calling(TextFile, CreateGlobalVar = "T") { ; read contents of file in output and %output% as global var ...  http://www.autohotkey.com/forum/viewtopic.php?p=313120#313120
	 global
	 FileRead, %CreateGlobalVar%, %TextFile%
	 Return, (%CreateGlobalVar%)
	}

; TF_Join_version_for_direct_calling
...
TF_Join_version_for_direct_calling(Text, StartLine = 1, EndLine = 0, SmartJoin = 0, Char = 0)
	{
	 ...
	 If (Endline > 0)
		Endline--
	 TF_MatchList:=_MakeMatchList_version_for_direct_calling(Text, StartLine, EndLine, 0, A_ThisFunc)
	 If (Char = 0)
		Char:=A_Space
	 Char_Org:=Char
...
TF_SetGlobal_version_for_direct_calling(var, content = "") ; helper function for TF_Split* to return array and not files, credits Tuncay :-)
	{
	 global
	 %var% := content
	}
...
TF_GetData_version_for_direct_calling(byref OW, byref Text, byref FileName)
	{
...
TF_SetWidth_version_for_direct_calling(Text,Width,AlignText)
	{
	 If (AlignText!=0 and AlignText!=1 and AlignText!=2)
		AlignText=0
	 If AlignText=0
		{
		 RetStr= % (Text)TF_Space_version_for_direct_calling(Width)
		 StringLeft, RetText, RetText, %Width%
		}
	 If AlignText=1
		{
		 Spaces:=(Width-(StrLen(Text)))
		 RetStr= % TF_Space_version_for_direct_calling(Round(Spaces/2))(Text)TF_Space_version_for_direct_calling(Spaces-(Round(Spaces/2)))
		}
	 If AlignText=2
		{
		 RetStr= % TF_Space_version_for_direct_calling(Width)(Text)
...
; Skan - http://www.autohotkey.com/forum/viewtopic.php?p=45880#45880
TF_Space_version_for_direct_calling(Width)
	{
	 Loop,%Width%
		Space=% Space Chr(32)
	 Return Space
...
TF_ReturnOutPut_version_for_direct_calling(OW, Text, FileName, TrimTrailing = 1, CreateNewFile_version_for_direct_calling = 0) {
	If (OW = 0) ; input was file, file_copy will be created, if it already exist file_copy will be overwritten
		{
		 IfNotExist, % FileName ; check if file Exist, if not return otherwise it would create an empty file. Thanks for the idea Murp|e
			{
			 If (CreateNewFile_version_for_direct_calling = 1) ; CreateNewFile_version_for_direct_calling used for TF_SplitFileBy* and others
				{
				 OW = 1
				 Goto CreateNewFile_version_for_direct_calling
				}
			 Else
				Return
			}
	 ...
	 CreateNewFile_version_for_direct_calling:
	 If (OW = 1) ; input was file, will be overwritten by output
		{
		 IfNotExist, % FileName ; check if file Exist, if not return otherwise it would create an empty file. Thanks for the idea Murp|e
			{
			If (CreateNewFile_version_for_direct_calling = 0) ; CreateNewFile_version_for_direct_calling used for TF_SplitFileBy* and others
				Return
			}
		 If (TrimTrailing = 1)
			 StringTrimRight, Text, Text, 1 ; remove trailing `n
...
; _MakeMatchList_version_for_direct_calling()
; Purpose:
...
_MakeMatchList_version_for_direct_calling(Text, Start = 1, End = 0, Col = 0, CallFunc = "Not available")
	{
	 ErrorList=
	 (join|
...
Error 03: Invalid StartLine parameter (only one + allowed)`nFunction used: %CallFunc%
	 ...
	 If (Col = 1)
		{
		 LongestLine:=TF_Stat_version_for_direct_calling(Text)
	 ...
	 If (TF_Count_version_for_direct_calling(Start,"+") > 1)
		 Error = 3
	 ...
	 If (Start < 0) ; remove last X lines from file, endline parameter ignored
		{
		 Start:=TF_Count_version_for_direct_callingLines_version_for_direct_calling(Text) + Start + 1
		 End=0 ; now continue
		}
	 ...
	 IfInString, Start, `+
		{
		 If (End = 0 or End = "") ; determine number of lines
			End:= TF_Count_version_for_direct_calling(Text, "`n") + 1
...
TF_Stat_version_for_direct_calling(Text)
	{
	 TF_GetData_version_for_direct_calling(OW, Text, FileName)
	 Sort, Text, f _AscendingLinesL_version_for_direct_calling
	 Pos:=InStr(Text,"`n")-1
	 Return pos
	}

_AscendingLinesL_version_for_direct_calling(a1, a2) ; used by TF_Stat_version_for_direct_calling
	{
