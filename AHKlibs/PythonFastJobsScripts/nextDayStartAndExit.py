...
config = ConfigParser()
config.read(path)
string_val = config.get('AutohotkeyConfig', 'DateForTimeManagementSoftwareStartAndExit')
print(string_val)
...
string_valYMD = string_valY + string_valM + string_valD
print(string_valYMD)
config.set('AutohotkeyConfig', 'DateForTimeManagementSoftwareStartAndExit', string_valYMD)
