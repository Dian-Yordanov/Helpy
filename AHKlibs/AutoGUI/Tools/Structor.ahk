...
Gui Font, s9, Segoe UI
Gui Add, ListView, hWndhOffsetList vLV x11 y286 w603 h180 +Checked +LV0x14000, Member|Data Type|32-bit Offset|64-bit Offset
LV_ModifyCol(1, 150)
LV_ModifyCol(2, 150)
LV_ModifyCol(3, 80)
LV_ModifyCol(4, 80)
...
hSysMenu := DllCall("GetSystemMenu", "Ptr", hMainWnd, "Int", False)
...
ShowSettings:
    ...
    Gui Add, ListView, hWndhHeaderList x124 y290 w200 h119 -Hdr +Checked +LV0x14000, Headers
