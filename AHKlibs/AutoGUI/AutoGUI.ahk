...
; Libraries
#Include Lib\AuxLib.ahk
#Include Lib\GuiTabEx.ahk
#Include Lib\Toolbar.ahk
#Include Lib\Scintilla.ahk
#Include Lib\AutoXYWH.ahk
#Include Include\Keywords.ahk
...
Expressive:
ScriptsManager:
    Run Tools\%A_ThisLabel%.ahk, Tools
Return
...
LoadToolsMenu() {
    If (FileExist(A_AppData . "\AutoGUI\Tools.ini")) {
        ...
        If (!FileExist(g_IniTools)) {
            FileCopy Tools\DefaultTools.ini, Tools\Tools.ini
            If (ErrorLevel) {
                FileCreateDir %A_AppData%\AutoGUI
                FileCopy Tools\DefaultTools.ini, %A_AppData%\AutoGUI\Tools.ini
                g_IniTools := A_AppData . "\AutoGUI\Tools.ini"
            }
        }
    }
...
#Include Lib\EnumIncludes.ahk
#Include Lib\DBGp.ahk
#Include Lib\LV_GroupView.ahk
#Include Tools\MagicBox\Functions\InputBoxEx.ahk
#Include Tools\MagicBox\Functions\SoftModalMessageBox.ahk

#Include Include\Properties.ahk
#Include Include\Editor.ahk
#Include Include\FontDialog.ahk
#Include Include\StylesDlg.ahk
#Include Include\MenuEditor.ahk
#Include Include\ToolbarEditor.ahk
#Include Include\CloneWindow.ahk
#Include Include\Resizers.ahk
#Include Include\Settings.ahk
#Include Include\Parser.ahk
#Include Include\ContextHelp.ahk
#Include Include\GenerateCode.ahk
#Include Include\FindReplace.ahk
#Include Include\ToolsDialog.ahk
#Include Include\Debug.ahk
