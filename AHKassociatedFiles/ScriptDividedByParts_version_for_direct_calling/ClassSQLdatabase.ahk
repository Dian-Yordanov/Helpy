;   ____   _                                 _____    ____    _        _   _            _____    ____                _       _
; / ____| | |                               / ____|  / __ \  | |      (_) | |          |  __ \  |  _ \              | |     | |
; | |      | |   __ _   ___   ___           | (___   | |  | | | |       _  | |_    ___  | |  | | | |_) |       __ _  | |__   | | __
; | |      | |  / _` | / __| / __|           \___ \  | |  | | | |      | | | __|  / _ \ | |  | | |  _ <       / _` | | '_ \  | |/ /
; | |____  | | | (_| | \__ \ \__ \           ____) | | |__| | | |____  | | | |_  |  __/ | |__| | | |_) |  _  | (_| | | | | | |   <
; \_____| |_|  \__,_| |___/ |___/          |_____/   \___\_\ |______| |_|  \__|  \___| |_____/  |____/  (_)  \__,_| |_| |_| |_|\_\
;                                 ______
;                                |______|
...
Class SQLiteDB Extends SQLiteDB.BaseClass {
   ...
   Class BaseClass {
      Static Version := ""
      Static _SQLiteDLL := A_MyDocuments . "\AHKHelpy\AHKlibs\SQLiteAHKdatabases\SQLite3.dll"
      Static _RefCount := 0
   ...
   __New() {
      ...
      If (This.Base._RefCount = 0) {
         ...
         If !FileExist(SQLiteDLL)
            If FileExist(A_MyDocuments . "\SQLiteDB.ini") {
