...
Gui, Add, Text, xp+250 cFFFFFF h%bottom_y_var% section 0x11

Gui, Add, Button, gWinR x20 yp+15 hwndHBT1Helpy, Win+R
Gui, Add, Button, gCtrlA %k_Position% hwndHBT2Helpy, Ctrl+A
Gui, Add, Button, gCtrlF %k_Position% hwndHBT3Helpy, Ctrl+F
Gui, Add, Button, gCtrlW %k_Position% hwndHBT4Helpy, Ctrl+W

; Gui, Add, Text, xp+70 cFFFFFF h100 section 0x11
; Gui, Add, Text, xp+90 cFFFFFF h100 ys 0x11
Gui, Add, Text, x20 yp+40 BackgroundTrans

Gui, Add, Button, gStartLinuxHelpy hwndHBT5Helpy yp ,StartLinuxHelpy
Gui, Add, Button, %k_Position% gTimeManager hwndHBT8Helpy,TimeManager

; Gui, Add, Text, x20 yp+20 section BackgroundTrans

; Gui, Add, Text, xp+90 cFFFFFF h100 ys 0x11

; Gui, Add, Text, %k_Position% cWhite,
; Gui, Add, Button, ys gClipboardMaster hwndHBTN,ClipboardMaster
; CCButton.Attach(HBTN, 0x008000)

;Gui, Add, Button, ys gLaunchBitwarden hwndHBTN,Bitwarden
;CCButton.Attach(HBTN, 0x0000FF)

; Gui, Add, Button, %k_Position% gLaunchEasyGitJS hwndHBTN,EasyGitJS
; CCButton.Attach(HBTN, 0xFF0000)

Gui, Add, Text, vBottom_Section yp+%bottom_y_var% x20 cFFFFFF w2000 section 0x10  

Gui, Add, Text, xs yp+20 cWhite, Left mouse click context menu toggle:
Gui, Add, Picture, xp+360 yp-8 +BackgroundTrans vCheckboxSwitchingButtonLauncher1 gCheckboxSwitchingButtonLauncherFunction1, %A_ScriptDir%\AHKassociatedFiles\resources\ImageFilesForAHK\off.png
Gui, Add, Picture, xp yp +BackgroundTrans vCheckboxSwitchingButtonLauncher2 gCheckboxSwitchingButtonLauncherFunction2 hidden, %A_ScriptDir%\AHKassociatedFiles\resources\ImageFilesForAHK\on3.png

Gui, Add, Text, x20 yp+55 cWhite, Toggle for writting into ProgramUsedLogger.txt:
Gui, Add, Picture, xp+360 yp-8 +BackgroundTrans vProgramUsedLogger_CheckboxSwitchingButton1 gProgramUsedLogger_CheckboxSwitchingButton_function1, %A_ScriptDir%\AHKassociatedFiles\resources\ImageFilesForAHK\off.png
Gui, Add, Picture, xp yp +BackgroundTrans vProgramUsedLogger_CheckboxSwitchingButton2 gProgramUsedLogger_CheckboxSwitchingButton_function2 hidden, %A_ScriptDir%\AHKassociatedFiles\resources\ImageFilesForAHK\on3.png
