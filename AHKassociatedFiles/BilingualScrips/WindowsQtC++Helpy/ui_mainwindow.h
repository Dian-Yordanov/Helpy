...
public:
    ...
    QPushButton *AltTab_context;
    QPushButton *TestMouseFunction_context;
    QPushButton *TestLocalFunction_context;
    QFrame *line_2;
    QWidget *horizontalLayoutWidget;
    QHBoxLayout *horizontalLayout_2;
    QPushButton *Exit_context;
    QPushButton *Exit_function;
...
""));
        ...
        AltTab_context = new QPushButton(verticalLayoutWidget);
        AltTab_context->setObjectName(QStringLiteral("AltTab_context"));
        AltTab_context->setMinimumSize(QSize(186, 0));
        AltTab_context->setStyleSheet(QLatin1String("QPushButton {\n"
"	color: rgb(255, 255, 255);\n"
"	background-color: rgb(84, 84, 84);\n"
"    border-style: outset;\n"
"    border-width: 2px;\n"
...
""));
        ...
        verticalLayout_2->addWidget(AltTab_context);

        TestMouseFunction_context = new QPushButton(verticalLayoutWidget);
        TestMouseFunction_context->setObjectName(QStringLiteral("TestMouseFunction_context"));
        TestMouseFunction_context->setMinimumSize(QSize(186, 0));
        TestMouseFunction_context->setStyleSheet(QLatin1String("QPushButton {\n"
"	color: rgb(255, 255, 255);\n"
"	background-color: rgb(84, 84, 84);\n"
"    border-style: outset;\n"
"    border-width: 2px;\n"
...
""));
        ...
        verticalLayout_2->addWidget(TestMouseFunction_context);

        TestLocalFunction_context = new QPushButton(verticalLayoutWidget);
        TestLocalFunction_context->setObjectName(QStringLiteral("TestLocalFunction_context"));
        TestLocalFunction_context->setMinimumSize(QSize(186, 0));
        TestLocalFunction_context->setStyleSheet(QLatin1String("QPushButton {\n"
"	color: rgb(255, 255, 255);\n"
"	background-color: rgb(84, 84, 84);\n"
"    border-style: outset;\n"
"    border-width: 2px;\n"
...
""));
        ...
        verticalLayout_2->addWidget(TestLocalFunction_context);
...
"}"));
        ...
        Exit_function = new QPushButton(horizontalLayoutWidget);
        Exit_function->setObjectName(QStringLiteral("Exit_function"));
        Exit_function->setMinimumSize(QSize(186, 0));
        Exit_function->setStyleSheet(QLatin1String("QPushButton {\n"
"	color: rgb(255, 255, 255);\n"
"	background-color: rgb(84, 84, 84);\n"
"    border-style: outset;\n"
"    border-width: 2px;\n"
...
"    padding: 6px;\n"
"}"));
        Exit_function->setFlat(false);

        horizontalLayout_2->addWidget(Exit_function);

        MainWindow->setCentralWidget(centralwidget);

        retranslateUi(MainWindow);

        TestLocalFunction_context->setDefault(true);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        AltTab_context->setText(QApplication::translate("MainWindow", "Alt + Tab", Q_NULLPTR));
        TestMouseFunction_context->setText(QApplication::translate("MainWindow", "PushButton", Q_NULLPTR));
        TestLocalFunction_context->setText(QApplication::translate("MainWindow", "PushButton", Q_NULLPTR));
        Exit_context->setText(QApplication::translate("MainWindow", "esc", Q_NULLPTR));
        Exit_function->setText(QApplication::translate("MainWindow", "Exit", Q_NULLPTR));
    } // retranslateUi
